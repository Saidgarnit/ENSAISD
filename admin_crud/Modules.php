...
// Store the module ID in a session variable
...
<body>
                                                ...
                                                <div class="card card-rounded">
                                                    <div class="card-body">
                                                        <div class="d-sm-flex justify-content-between align-items-start">
                                                            <div>
                                                                <h4 class="card-title card-title-dash">Tous Les Modules</h4>
                                                                    ...
                                                                    <?php foreach ($modules as $module) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <a class="btn btn-warning" href="modules_edit.php?id=<?= $module['ModuleID']; ?>">
                                                                                            Modifier
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex">
                                                                                    <div class="row">
                                                                                    <button type="button" class="btn btn-danger delete-btn" data-module-id="<?= $module['ModuleID']; ?>">Supprimer</button>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    if (confirmed) {
                        // Send AJAX request to delete the module
    ...
    if (isset($_POST['delete_id'])) {
        ...
        $deleteQuery = $db->prepare("DELETE FROM modules WHERE ModuleID = :delete_id");
