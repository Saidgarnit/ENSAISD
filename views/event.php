      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-page-breadcrumb-area">
            <h1 style="color: aliceblue">Evenements</h1>
            <p style="color: aliceblue">
              Découvrez les événements passionnants à venir dans nos facultés,
              où l'innovation, la découverte et l'apprentissage se rencontrent
